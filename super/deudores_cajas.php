...
<div class="wrapper">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-white">
              <div class="card-header">
                <h3 class="card-title" id="title">Agregar Cajas a Deudas</h3>
              </div>
              <!-- Formulario para agregar clientes -->
              <form class="card-body" method="post" action="guardar_deudor_cajas.php">
              <?php
                ...
                <div class="form-group">
                    <label for="cantidadCajas">Cajas:</label>
                    <input type="number" step="0.01" class="form-control" id="cantidadCajas" name="cantidadCajas" placeholder="Ingrese la cantidad de cajas" required>
                </div>

                <div class="form-group">
                    <label for="cantidadTapas">Tapas:</label>
                    <input type="number" step="1" class="form-control" id="cantidadTapas" name="cantidadTapas" placeholder="Ingrese la cantidad de tapas" required>
                </div>
  ...
  <!-- Bootstrap 4 JS -->
    ...
    <script src="../job_js/a2.js"></script>  <!-- Script de búsqueda en tiempo real -->
<script>
