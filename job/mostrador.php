...
<div class="wrapper">
  ...
  <!-- Bootstrap 4 JS -->
  <!--<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script> 'En caso de fallar la soluciones esta en 'mostrador-s-.js''-->
  <!-- <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.bundle.min.js"></script> 'En caso de fallar la soluciones esta en 'mostrador-s.js''-->
      <!-- Bootstrap 4 JS -->
