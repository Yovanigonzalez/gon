...
$sql_verificar = "SELECT * FROM productos WHERE nombre = '$nombreProducto'";
...
if ($result->num_rows > 0) {
    ...
    $sql_insertar = "INSERT INTO productos (nombre) VALUES ('$nombreProducto')";
...
header("Location: agregar_productos");
exit();
?>
